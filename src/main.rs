...
fn main()  -> anyhow::Result<()> {
    ...
    for _ in 0..100 {
        ...
        if v > best_value{
            ...
            println!("New Best: {}, {}, {}, {}, {}, {}", best_b1, best_b2, best_b3, best_r1, best_r2, best_value);
        }else{
            println!("Not Best: {}, {}, {}, {}, {}, {}", choices[b1 as usize], choices_med[b2 as usize], choices_lg[b3 as usize], choices_r1[r1 as usize], choices_r2[r2 as usize], v);
        }
